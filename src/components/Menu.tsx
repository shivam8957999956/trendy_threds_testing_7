...
const Menu = () => {
  ...
  return (
    <div className="flex flex-row">
      ...
      />
      {open && (
        <div className="absolute bg-black text-white left-0 top-20 w-full h-[calc(100vh-80px)] flex flex-col items-center justify-center gap-8 text-xl z-[1000]">          <Link href="/" onClick={() => setOpen(false)}>
            Homepage
          </Link>
