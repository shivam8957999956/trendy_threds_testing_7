...
const AboutUs = () => {
  return (
    <div className="min-h-screen  p-8">
      ...
      <div className="mt-16">
        <h2 className="text-5xl font-bold text-gray-900 mb-4 drop-shadow-lg">
          Our Mission
        </h2>
        <p className="text-xl text-gray-700">
          Our mission is to provide high-quality, luxurious clothing that makes
          you feel confident and stylish. We believe in sustainable fashion and
      ...
      <div className="mt-16">
        ...
        <ul className="list-disc list-inside text-xl text-gray-700 space-y-2">
          <li>
            Trendy Designs: Our design team is always ahead of the curve,
            staying on top of the latest fashion trends to bring you the coolest
            and most innovative t-shirts.
          </li>
          <li>
            Quality Materials: We use only the finest materials to ensure that
            our t-shirts are not only stylish but also comfortable and durable.
          </li>
          <li>
            Ethical Production: We believe in sustainable fashion. Our products
            are made with care, ensuring ethical production practices and a
            minimal environmental footprint.
          </li>
          <li>
            Customer-Centric Approach: Our customers are at the heart of
            everything we do. We strive to provide an exceptional shopping
            experience, from easy navigation on our website to fast and reliable
            delivery.
          </li>
        </ul>
      </div>
      <div className="mt-16">
        ...
        <p className="text-xl text-gray-700">
          Our team is a vibrant mix of fashion enthusiasts, designers, and
          innovators, all driven by a shared passion for style and quality. We
          work tirelessly to bring our vision to life and ensure that each piece
          in our collection is a work of art.
        </p>
      </div>
      <div className="mt-16">
        <h2 className="text-5xl font-bold text-gray-900 mb-4 drop-shadow-lg">
        ...
        <p className="text-xl text-gray-700">
          Trendy Threds is more than just a clothing brand, it&apos;s a
          community. We love seeing how our customers style their favorite
          pieces, and we encourage you to share your looks with us on social
          media using #kapdokobolnedo. Together, we can inspire others to
          embrace their unique style and live boldly.
        </p>
      </div>
      <div className="mt-16">
        <h2 className="text-5xl font-bold text-gray-900 mb-4 drop-shadow-lg">
        ...
        <p className="text-xl text-gray-700">
          ...
          to us at services@trendythreds.in or connect with us on instagram
